...
public class BrandItemTopicCore {
	...
	// Evaluate log likelihood that adoption data of users in [userBegin, userEnd) are generated by the corresponding learned parameters
	// i.e. distributions (topic preference, decision preference)
	// Record the ll to Likelihood recorder
	public static void evalLikelihood(DataSet ds, int userBegin, int userEnd, Distributions dists, LikelihoodRecorder llRecorder) {
		// TODO
	}
